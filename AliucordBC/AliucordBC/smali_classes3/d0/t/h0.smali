...
.method public static final emptyMap()Ljava/util/Map;
    ...
    .line 1
    sget-object v0, Ld0/t/x;->j:Ld0/t/x;
...
.method public static final getValue(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0, p1}, Ld0/t/f0;->getOrImplicitDefaultNullable(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final varargs hashMapOf([Lkotlin/Pair;)Ljava/util/HashMap;
    ...
    invoke-static {v0, p0}, Ld0/t/h0;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static final varargs linkedMapOf([Lkotlin/Pair;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {p0, v0}, Ld0/t/h0;->toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final minus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {p0}, Ld0/t/h0;->toMutableMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Ld0/t/r;->removeAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z

    invoke-static {p0}, Ld0/t/h0;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Ld0/t/g0;->toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Ld0/t/h0;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Ld0/t/g0;->mapOf(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Ld0/t/h0;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 7
    invoke-static {p1, p0}, Ld0/t/h0;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 8
    invoke-static {p1, p0}, Ld0/t/h0;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
