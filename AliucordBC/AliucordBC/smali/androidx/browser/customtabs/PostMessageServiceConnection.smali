...
.field private mService:Lx/a/a/c;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field private final mSessionBinder:Lx/a/a/a;
...
.method public constructor <init>(Landroidx/browser/customtabs/CustomTabsSessionToken;)V
    ...
    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Lx/a/a/a;
...
.method private isBoundToService()Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Lx/a/a/c;
...
.method private notifyMessageChannelReadyInternal(Landroid/os/Bundle;)Z
    ...
    .line 3
    :try_start_0
    iget-object v2, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Lx/a/a/c;

    iget-object v3, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Lx/a/a/a;

    invoke-interface {v2, v3, p1}, Lx/a/a/c;->onMessageChannelReady(Lx/a/a/a;Landroid/os/Bundle;)V
    :try_end_0
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 1
    invoke-static {p2}, Lx/a/a/c$a;->asInterface(Landroid/os/IBinder;)Lx/a/a/c;

    move-result-object p1

    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Lx/a/a/c;
...
.method public final postMessage(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v2, v3, p1, p2}, Lx/a/a/c;->onPostMessage(Lx/a/a/a;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
