...
# direct methods
.method public constructor <init>(Lb/a/t/a/k$c$a;Lb/a/t/a/f;Ljava/util/regex/Pattern;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    iput-object p2, p0, Lb/a/t/a/m;->a:Lb/a/t/a/f;
...
.method public parse(Ljava/util/regex/Matcher;Lcom/discord/simpleast/core/parser/Parser;Ljava/lang/Object;)Lcom/discord/simpleast/core/parser/ParseSpec;
    ...
    iget-object v2, p0, Lb/a/t/a/m;->a:Lb/a/t/a/f;

    invoke-direct {v1, p2, v0, p1, v2}, Lb/a/t/a/k$c;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lb/a/t/a/f;)V

    const-string/jumbo p1, "node"

    .line 5
    invoke-static {v1, p1}, Ld0/z/d/m;->checkNotNullParameter(Ljava/lang/Object;Ljava/lang/String;)V
